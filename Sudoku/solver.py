# https://github.com/basnetsoyuj/MxN-Sudoku-Solver/blob/master/solver.py
...
if __name__=='__main__':
    ...
    print_array(puzzle1, order1)
    solve(puzzle2, order2)
    print_array(puzzle2, order2)